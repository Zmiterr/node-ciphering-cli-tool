...
2. `Config` option is required and should be validated. In case of invalid config **human-friendly** error should be printed in `stderr` and the process should exit with non-zero status code.
